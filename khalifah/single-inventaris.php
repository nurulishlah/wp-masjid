	        ...
	        <?php
				if (have_posts()):
					...
					$inv_fields = get_post_meta($post->ID, 'inv_fields', true);
			     	?>
					    <div class="sing__date"><?php echo __('Inventory', 'wp-masjid'); ?></div>
						...
						<div class="sing__content sing__nopost"> 
						    <?php the_content(); ?>
							<h3><?php echo __( 'Inventory List', 'wp-masjid' ); ?></h3>
							<table class="sing__notable">
							    <tr>
								    <td class="sing__firsttab"><?php echo __( 'No', 'wp-masjid' ); ?></td>
									<td><?php echo __( 'Name', 'wp-masjid' ); ?></td>
									<td class="sing__contab"><?php echo __( 'Count', 'wp-masjid' ); ?></td>
									<td class="sing__contab"><?php echo __( 'Good', 'wp-masjid' ); ?></td>
									<td class="sing__contab"><?php echo __( 'Broken', 'wp-masjid' ); ?></td>
								</tr>
							    <?php 
