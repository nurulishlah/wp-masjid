			...
			while (have_posts()): the_post();
				...
				if (has_post_thumbnail()) { 
					...
					if ( get_theme_mod('thumb_image') != "" ) {
						echo '<meta property="og:image" content="'. get_theme_mod('thumb_image') .'" />';
						echo '<meta property="og:image:secure_url" content="'. get_theme_mod('thumb_image') .'" />';
						echo '<meta name="twitter:image" content="'. get_theme_mod('thumb_image') .'" />';
					} else {
						echo '<meta property="og:image" content="'. get_theme_file_uri('wm-img/share.jpg') .'" />';
						echo '<meta property="og:image:secure_url" content="'. get_theme_file_uri('wm-img/share.jpg') .'" />';
						echo '<meta name="twitter:image" content="'. get_theme_file_uri('wm-img/share.jpg') .'" />';
					}
				}
			endwhile;
		endif; 
