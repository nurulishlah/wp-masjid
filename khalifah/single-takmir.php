	        ...
	        <?php
				if (have_posts()):
					...
					$jabat = get_post_meta($post->ID, '_jabat', true);
			     	?>
					    <div class="sing__date"><?php echo __('Takmir', 'wp-masjid'); ?></div>
				    	<h1 class="sing__heading"><?php the_title(); ?></h1>
						<?php 
						    if ( has_post_thumbnail() ) {
								echo '<div class="takmir__thumb">';
						...
						<div class="sing__content sing__nopost"> 
						    <table class="sing__notable">
								<tr>
						    		<td><strong><?php echo __( 'Name', 'wp-masjid' ); ?></strong></td>
						    		<td><?php the_title(); ?></td>
					    		</tr>
								<tr>
						    		<td><strong><?php echo __( 'Position', 'wp-masjid' ); ?></strong></td>
						    		<td><?php echo esc_html( $jabat ); ?></td>
					    		</tr>
					    	</table>
